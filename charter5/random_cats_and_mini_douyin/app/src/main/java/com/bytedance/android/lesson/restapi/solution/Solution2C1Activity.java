...
public class Solution2C1Activity extends AppCompatActivity {
    ...
    public void requestData(View view) throws IOException {
        ...
        Retrofit retrofit= new Retrofit.Builder()
                ...
                .build();
        ICatService iCatServiceApi=retrofit.create(ICatService.class);
        Call<List<Cat>> listCall=iCatServiceApi.getFiveCats(5);
        //异步请求
        listCall.enqueue(new Callback<List<Cat>>() {
            ...
            public void onResponse(Call<List<Cat>> call, Response<List<Cat>> response) {
                if(response.isSuccessful()) {
                    ...
                    restoreBtn();
                    Toast.makeText(Solution2C1Activity.this, "获取失败，请重试！", Toast.LENGTH_SHORT).show();
                }
            }
